                ...
                <View style={GlobalStyleSheet.container}>
                    <View style={{ borderRadius: 19, backgroundColor: '#EEF3FF', padding: 16, marginTop: 8, overflow: 'hidden' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <View style={{ flex: 1, marginLeft: 11 }}><Text style={[FONTS.font, FONTS.fontTitle, { color: '#18336D' }]}>How can we help?</Text><Text style={[FONTS.fontXs, { color: '#49618F', lineHeight: 17, marginTop: 3 }]}>Find quick answers or contact QOT.</Text></View>
                        </View>
                    ...
                    <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: 10 }}>
                        ...
                        <QuickLink icon="file-text" title="Terms" detail="Rules for using QOT" color="#EA580C" background="#FFF7ED" onPress={() => navigation.navigate('LegalCenter', { tab: 'terms' })} />
                    ...
                    <Text style={[FONTS.fontXs, FONTS.fontTitle, { color: colors.text, textTransform: 'uppercase', letterSpacing: 0.65, marginTop: 22, marginBottom: 9 }]}>Contact QOT</Text>
                    <View style={{ borderRadius: 16, borderWidth: 1, borderColor: colors.borderColor, overflow: 'hidden' }}>
                        {[
